...
## Status
merged
<!-- advanced from `built@loop/2026-09-08-adapter-drift-coverage` by `board --mark-merged` on 2026-09-23: build merged as faee8d0. The word `built@loop/2026-09-08-adapter-drift-coverage` on a merged spec made it indistinguishable from a buildable one. -->
